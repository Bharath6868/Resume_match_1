...
tips = """* Upload your resume in the sidebar (PDF only).
* Copy & Paste job description for job you are applying for.
* Submit your data & see the magic."""

st.write(tips)

st.sidebar.header('Upload your resume here', divider='green')
st.sidebar.subheader('Upload PDF files only.')
...
if pdf_doc:
    ...
    st.sidebar.write('Upload you PDF first.')

job_desc = st.text_area('Copy & Paste your job description (Press ctrl + enter to submit)',
                        max_chars=10000)
...
if job_desc:
    if pdf_doc == None:
        ...
        with st.spinner('Processing your resume & job description...'):
